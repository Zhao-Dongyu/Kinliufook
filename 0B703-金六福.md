...
| 型号 | 主要技术指标 | 成本（元） | 其它 |
| :---: | :--- | :--- | :--- |
| 树莓派 | 处理器 芯片组：Broadcom BCM2837 cortex-A53 64bit SoCat 1.2GHz;内存：1GB SDRAM@400MHz; 无线网络：802.11b/b/n wireless LAN; 蓝牙：Bluetooth 4.1/BLE; USB：4*USB Ports; 电源要求：5V/2.5A; 工作环境温度:0-50℃
 | 220 | 采用 |
