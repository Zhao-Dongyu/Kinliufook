...
![warning]
(https://github.com/WolffyAndy/Kinliufook/blob/zhaodongyu/img/warning.jpg) 这一步我出现了`E: Could not get lock /var/lib/apt/lists/lock - open`的情况，网络上有说删掉`/var/lib/apt/lists/lock`就好，这种方法比较暴力。
...
将编译好的内核文件Image拷贝到/mnt/boot/下，并且给他去个名字，叫做kernel8.img好了。因为里面已经有一个kernel7.img了
