...
跑了22分钟电脑烫得严重，庆幸当时配虚拟机还算是给了8个核而不是1个，否则应该需要更久。
...
编译好的内核位于`/Home/Desktop/linux/arch/arm64/boot`
...
![](./img/module.jpg)
uname -a查看kernel版本，不是linux-headers-4.14.98+，Makefile里面改为linux-headers-4.14.98-v7+
